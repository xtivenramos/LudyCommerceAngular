...
export interface ITreeEventHandlersMap extends IDragEventsHandlersMap {
    ...
    [TreeEvents.itemRightClick]: (id: string, e: Event) => void;
    [TreeEvents.itemDblClick]: (id: string, e: Event) => void;
    [TreeEvents.beforeCollapse]: (id: string) => boolean | void;
    [TreeEvents.afterCollapse]: (id: string) => void;
    [TreeEvents.beforeExpand]: (id: string) => boolean | void;
    [TreeEvents.afterExpand]: (id: string) => void;
